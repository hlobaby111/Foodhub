...
app.use('/api/admin/refunds', require('./routes/refundRoutes'));
app.use('/api/admin/payouts', require('./routes/payoutRoutes'));
app.use('/api/admin/settings', require('./routes/settingsRoutes'));
app.use('/api/admin/delivery', require('./routes/deliveryAdminRoutes'));
